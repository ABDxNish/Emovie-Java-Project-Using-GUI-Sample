...
public class Payment3 extends JFrame implements ActionListener
{
	...
	public Payment3(){
		...
		this.setTitle("EMovie Payment Page 3");
	...
	public void actionPerformed(ActionEvent ae){
		if(ae.getSource()==b1){
			SelectItem3 s3=new SelectItem3();
