...
public class ViewingandTicketType4 extends JFrame implements ActionListener{
...
private JPanel p1;
 ...
 public ViewingandTicketType4()
	 {  
	 
	 
	   
       this.setTitle("EMovie Ticket Type4");
	 ...
	 public void initialComponents(){
		...
		cD=new JRadioButton("VIP-(3100BDT)");
		...
		dD=new JRadioButton("Regular-(300BDT)");
		...
		p1.add(imageLabe13);
		 ...
		 ImageIcon image = new ImageIcon("the flash2.jpg");
		...
		public void actionPerformed(ActionEvent ae){
			if(ae.getSource()==backbutton){
				MovieTimeShow m2=new MovieTimeShow();
				this.setVisible(false);
				m2.setVisible(true);
			}
			else if(ae.getSource()==button){
				Booking3 b2=new Booking3();
				b2.setVisible(true);
			 this.setVisible(false);
			}
		}
