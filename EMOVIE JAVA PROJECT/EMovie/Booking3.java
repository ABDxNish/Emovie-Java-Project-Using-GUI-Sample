...
public class Booking3 extends JFrame implements ActionListener
{
	...
	public Booking3 (){
			this.setTitle("EMovie Ticket Booking 3");
	...
	public void actionPerformed(ActionEvent ae){
		if(ae.getSource()==b1){
			ViewingandTicketType4 a1=new ViewingandTicketType4();
			a1.setVisible(true);
			this.setVisible(false);
		}
		else if(ae.getSource()==b2){
			SelectItem4 a2=new SelectItem4();
			a2.setVisible(true);
			this.setVisible(false);
		}
	}
