...
public class ViewingandTicketType1 extends JFrame implements ActionListener{
...
JPanel p1;
 ...
 public ViewingandTicketType1()
	 {  
	 
	 
	   
         this.setTitle("EMovie Ticket Type1");
      ...
      //  imageLabe13.setVerticalAlignment(JLabel.TOP);
       // imageLabe13.setHorizontalAlignment(JLabel.CENTER);
		p1.add(imageLabe13);
		 ...
		 ImageIcon image = new ImageIcon("shazam2.jpg");
	...
	public void actionPerformed(ActionEvent ae){
		if(ae.getSource()==button){
			...
			MovieTimeShow w1=new MovieTimeShow();
			w1.setVisible(true);
			this.setVisible(false);
		}
	}
