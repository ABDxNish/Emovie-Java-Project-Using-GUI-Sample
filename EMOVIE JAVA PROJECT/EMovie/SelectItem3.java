...
public class SelectItem3 extends JFrame implements ActionListener
{
	private Container c;
	...
	SelectItem3()
	{
		this.setTitle("EMovie Select Time 3");
      ...
      public void initialComponents(){
		...
		ImageIcon image = new ImageIcon("JhonwickO.jpg");
