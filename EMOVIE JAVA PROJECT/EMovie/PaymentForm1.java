...
public class PaymentForm1 extends JFrame implements ActionListener {
    ...
    public PaymentForm1() {
        ...
        constraints.gridx = 0;
        constraints.gridy = 0;
        constraints.insets = new Insets(10, 10, 10, 10); //row,col,horizontal,vertical gap

        mainPanel.setBackground(new Color(232, 78, 133));
	...
	submitButton = new JButton("Submit");
        ...
        JLabel welcomeLabel = new JLabel("Welcome to bKash Digital Payment System");
